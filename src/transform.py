...
#x,y,z coordinates of charucoboard corner wrt battery
x_axis = 0.23
y_axis = 0.34
z_axis = 0.57
...
R_battery = Rotation.from_euler(
    "XYZ", [rollB, pitchB, yawB], degrees=True).as_matrix()
...
class DataAnalyzer:
    ...
    def matrix(self, msg):
        ...
        R_cam = Rotation.from_euler(
            "XYZ", [roll, pitch, yaw], degrees=True).as_matrix()
